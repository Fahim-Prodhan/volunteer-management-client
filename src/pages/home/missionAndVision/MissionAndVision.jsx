...
const MissionAndVision = () => {
    ...
    return (
        <div >
            ...
            <motion.div initial={{opacity:.7, scale:0.7, x: -500}} whileInView={{opacity:1, scale:1,x:0}} transition={{duration: 0.6}} className='grid lg:grid-cols-2 items-center gap-6'>
                <div>
            ...
            <motion.div initial={{opacity:.7, scale:0.7, x: 500}} whileInView={{opacity:1, scale:1,x:0}} transition={{duration: 0.6}} className='grid lg:grid-cols-2 items-center mt-12 gap-6'>
                <div>
                    <img src={img2} alt="" />
                </div>
                <div>
